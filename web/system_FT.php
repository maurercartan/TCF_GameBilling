...
<?php
    echo "
        ...
        <div class='resourcesystem'>
            ...
            <p style='font-size: 18px;'>FF:不消費玩家即為前7日與8-45日皆無課金者 FT:慢熱玩家即為前7日無課金8-45日有課金者</p>            <hr>
            <h1> </h1>
...
?>
  ...
  <iframe src="T2中文化_FT.html" width="100%" height="100%" frameborder="0" scrolling="no"> </iframe>
